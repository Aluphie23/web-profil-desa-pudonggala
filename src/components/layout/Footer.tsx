        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/infografis" className="text-white/50 hover:text-white hover:translate-x-1 inline-block transition-all duration-300">Infografis</Link></li>
              ...
              <li><Link href="/umkm" className="text-white/50 hover:text-white hover:translate-x-1 inline-block transition-all duration-300">Hasil Bumi</Link></li>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/samara.gala?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary hover:shadow-glow transition-all duration-300">
